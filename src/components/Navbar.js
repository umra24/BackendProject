...
import avatar11 from '../data/avatar11.png';
...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between p-2 md:ml-0 md:mr-2 relative bg-white">
      ...
      <div className="flex" >
        ...
        <TooltipComponent content="Profile" position="BottomCenter">
          <div
            className="flex items-center ml-14 gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg"
          >
            <img
